...
struct average_int_wrapper : conversion_wrapper_base<T, average_int_wrapper<T>> {
    ...
    static constexpr auto convert_binary_result(const L& lhs, const R& rhs, Op op) noexcept {
        ...
        constexpr auto lhs_int_bits = std::numeric_limits<std::make_unsigned_t<lhs_rep>>::digits - lhs_traits::fractional_digits;
        constexpr auto rhs_int_bits = std::numeric_limits<std::make_unsigned_t<rhs_rep>>::digits - rhs_traits::fractional_digits;
        ...
        constexpr auto result_frac_bits = std::numeric_limits<std::make_unsigned_t<result_rep>>::digits - avg_int_bits;
