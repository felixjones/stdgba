...
namespace gba::format::bits {
    ...
    constexpr std::size_t render_string_value(char* out, std::size_t cap, const T& value, const format_spec& spec) {
        ...
        switch (align) {
            case format_spec::align_t::center:
                ...
                break;
            case format_spec::align_t::right: leftPad = pad; break;
    ...
    constexpr std::size_t render_integer_value(char* out, std::size_t cap, const T& value, const format_spec& spec) {
        ...
        const auto effectiveType = spec.fmt_type == format_spec::type_t::default_fmt ? format_spec::type_t::decimal
                                                                                     : spec.fmt_type;
        ...
        if (effectiveType == format_spec::type_t::grouped && grouping == format_spec::grouping_t::none) {
            grouping = format_spec::grouping_t::comma;
        }
        ...
        if (spec.alternate_form) {
            switch (effectiveType) {
                ...
                case format_spec::type_t::hex_lower:
                    ...
                    prefix[prefixLen++] = 'x';
                    break;
                case format_spec::type_t::hex_upper:
                    prefix[prefixLen++] = '0';
                    prefix[prefixLen++] = 'X';
                    break;
                default: break;
