...
Flash and EEPROM access in tonclib requires manual BIOS calls or library functions. stdgba compiles command sequences at build time and provides stream types for EEPROM, replacing the raw register manipulation.
