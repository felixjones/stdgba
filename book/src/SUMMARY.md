...
- [Registers & Peripherals](./concepts/registers.md)
- [Fixed-Point Math](./concepts/fixed-point.md)
- [Angles](./concepts/angles.md)
- [Interrupts](./concepts/interrupts.md)
- [Timers](./concepts/timers.md)
- [Key Input](./concepts/key-input.md)
...
- [DMA PCM Playback](./audio/dma-pcm.md)
...
- [`gba::link`](./reference/link.md)
- [`gba::backup`](./reference/backup.md)
...
- [Peripheral Registers](./reference/peripherals.md)
    ...
    - [Serial Communication](./reference/peripherals/serial.md)
    - [Keypad](./reference/peripherals/keypad.md)
    - [Interrupts](./reference/peripherals/interrupts.md)
    - [System](./reference/peripherals/system.md)
    - [Video Memory](./reference/peripherals/video-memory.md)
    - [Undocumented Registers](./reference/peripherals/undocumented.md)
